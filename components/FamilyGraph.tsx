...
import { Network, User, Crown, Plus, X, ArrowUp } from 'lucide-react';
...
const getSiblingRank = (person: FamilyMember, allMembers: FamilyMember[]) => {
...
const calculateRelationshipLabel = (target: FamilyMember, center: FamilyMember, allMembers: FamilyMember[]): string | null => {
